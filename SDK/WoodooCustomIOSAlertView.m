...
const static CGFloat kWoodooCustomIOSAlertViewDefaultButtonHeight       = 50;
const static CGFloat kWoodooCustomIOSAlertViewDefaultButtonSpacerHeight = 1;
const static CGFloat kWoodooCustomIOSAlertViewCornerRadius              = 7;
const static CGFloat kWoodooCustomIOS7MotionEffectExtent                = 10.0;

@implementation WoodooCustomIOSAlertView
...
- (void)customIOS7dialogButtonTouchUpInside: (WoodooCustomIOSAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    [self close];
}
...
- (UIView *)createContainerView
{
    ...
    CGFloat cornerRadius = kWoodooCustomIOSAlertViewCornerRadius;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton.layer setCornerRadius:kWoodooCustomIOSAlertViewCornerRadius];
...
- (CGSize)countScreenSize
{
    if (buttonTitles!=NULL && [buttonTitles count] > 0) {
        buttonHeight       = kWoodooCustomIOSAlertViewDefaultButtonHeight;
        buttonSpacerHeight = kWoodooCustomIOSAlertViewDefaultButtonSpacerHeight;
    } else {
        buttonHeight = 0;
...
- (void)applyMotionEffects {
    ...
    horizontalEffect.minimumRelativeValue = @(-kWoodooCustomIOS7MotionEffectExtent);
    horizontalEffect.maximumRelativeValue = @( kWoodooCustomIOS7MotionEffectExtent);

    UIInterpolatingMotionEffect *verticalEffect = [[UIInterpolatingMotionEffect alloc] initWithKeyPath:@"center.y"
                                                                                                  type:UIInterpolatingMotionEffectTypeTiltAlongVerticalAxis];
    verticalEffect.minimumRelativeValue = @(-kWoodooCustomIOS7MotionEffectExtent);
    verticalEffect.maximumRelativeValue = @( kWoodooCustomIOS7MotionEffectExtent);
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if ([touch.view isKindOfClass:[WoodooCustomIOSAlertView class]]) {
        [self close];
    }
}
